...
(async () => {
  ...
  function processData(data) {
    ...
    let gatewayNo = [];
    const limit = resultQuery.length;
    ...
    // key 0, 1, 2 hasil filter
    // key 2, 3, 4 data sebelum filter
    ...
    console.log(maArray.length);
    let obj = maArray[maArray.length - 1];
    for(let h = maArray.length - 20; h < maArray.length; h++){
      console.log(maArray[h]);
    }
    
    const position = calculatePosition(obj["94A408B2EE24"], obj["94A408B60B80"], obj["94A408B60BAC"]);
  }
